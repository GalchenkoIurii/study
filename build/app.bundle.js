...
var _filmDetails = __webpack_require__(2);
...
function filmDetails() {
    ...
    var filmContainer = document.querySelector('.list-movies');
    ...
    console.log(tempData.data.movies[tempData.data.movies.findIndex(function (item) {
